                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a href="" class="btn btn-primary" id="editButton" data-toggle="modal"
                                            data-target="#editPTK"
                                            data-id_correction_form="{{$correction_form->id_correction_form}}"
                                            data-devience="{{$correction_form->devience}}"
                                            data-causes="{{$correction_form->causes}}"
                                            data-plan="{{$correction_form->plan}}">
                                            <span class="cil-pencil btn-icon mr-2"></span>PTK-Akar Penyebab & Rencana
                                            Perbaikan
                                        </a>
                                    </td>
                                </tr>
            ...
            <div class="modal-body">
                <form action="{{route('ptk.edit',[$id_audit])}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled type="text" class="form-control-file" id="edit_devience" name="devience"
                            cols="30" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlFile1">Akar Penyebab</label>
                        <textarea type="text" class="form-control-file" id="edit_causes" name="causes" cols="30"
                            rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlFile1">Rencana Perbaikan</label>
                        <textarea type="text" class="form-control-file" id="edit_plan" name="plan" cols="30"
                            rows="3"></textarea>
                    </div>
            </div>
