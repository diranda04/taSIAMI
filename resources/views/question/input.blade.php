            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                    <a href="{{ url ('standard_component/'.$standard_component->id_standard_component')}}" class="btn btn-success mb-2">Back</a>
                      <table class="table table-responsive-sm table-striped">
                        ...
                        @foreach ($questions as $question)
                          ...
                          <th scope="row">{{$question->id_question}}</th>
                            ...
                            <form action="{{ url('question/'.$question->id_question) }}" method="post">
                          @csrf
                          @method('DELETE')
...
<div class="modal fade" id="editQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{url ('/question/'.$id_standard_component)}}" method="POST">
      @csrf
      @method('PATCH')
